/*! @license DOMPurify 2.4.7 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.4.7/LICENSE */ function I(
  r,
) {
...
var Vt = b(Array.prototype.forEach),
  st = b(Array.prototype.pop),
  X = b(Array.prototype.push),
  le = b(String.prototype.toLowerCase),
  De = b(String.prototype.toString),
  Xt = b(String.prototype.match),
  R = b(String.prototype.replace),
  qt = b(String.prototype.indexOf),
  Kt = b(String.prototype.trim),
...
function P(r) {
  var n = Yt(null),
    o;
  for (o in r) se(Wt, r, [o]) === !0 && (n[o] = r[o]);
  return n;
}
function ne(r, n) {
  for (; r !== null; ) {
...
var ut = A([
  ...
  ie = A(["xlink:href", "xml:id", "xlink:title", "xml:space", "xmlns:xlink"]),
  er = L(/\{\{[\w\W]*|[\w\W]*\}\}/gm),
  tr = L(/<%[\w\W]*|[\w\W]*%>/gm),
  rr = L(/\${[\w\W]*}/gm),
  ar = L(/^data-[\-\w.\u00B7-\uFFFF]/),
...
function dt() {
  ...
  if (
    ((n.version = "2.4.7"),
    (n.removed = []),
    !r || !r.document || r.document.nodeType !== 9)
  )
    return (n.isSupported = !1), n;
  var o = r.document,
    s = r.document,
    c = r.DocumentFragment,
    g = r.HTMLTemplateElement,
    y = r.Node,
    N = r.Element,
    B = r.NodeFilter,
    $ = r.NamedNodeMap,
    vt = $ === void 0 ? r.NamedNodeMap || r.MozNamedAttrMap : $,
    Tt = r.HTMLFormElement,
    ht = r.DOMParser,
    q = r.trustedTypes,
    K = N.prototype,
    _t = ne(K, "cloneNode"),
  ...
  var S = fr(q, o),
    ...
    Z = s,
    me = Z.implementation,
    yt = Z.createNodeIterator,
    gt = Z.createDocumentFragment,
    bt = Z.getElementsByTagName,
    St = o.importNode,
    Ue = {};
  try {
  ...
  var pe = er,
    ...
    Te = ir,
    m = null,
    ze = l({}, [].concat(O(ut), O(we), O(Ce), O(Ie), O(ft))),
    p = null,
    Ge = l({}, [].concat(O(ct), O(xe), O(mt), O(ie))),
    f = Object.seal(
      Object.create(null, {
        tagNameCheck: {
          writable: !0,
    ...
    Xe = null,
    qe = l({}, ["audio", "video", "img", "source", "image", "track"]),
    ge = null,
    Ke = l({}, [
      "alt",
      "class",
    ...
    Dt = l({}, [ee, te, M], De),
    k,
    Mt = ["application/xhtml+xml", "text/html"],
    wt = "text/html",
    d,
    W = null,
    Ct = s.createElement("form"),
    Ze = function (e) {
    ...
    Re = function (e) {
      (W && W === e) ||
        ...
        (e = P(e)),
        (k =
          Mt.indexOf(e.PARSER_MEDIA_TYPE) === -1
            ? (k = wt)
            : (k = e.PARSER_MEDIA_TYPE)),
        (d = k === "application/xhtml+xml" ? De : le),
        (m = "ALLOWED_TAGS" in e ? l({}, e.ALLOWED_TAGS, d) : ze),
        (p = "ALLOWED_ATTR" in e ? l({}, e.ALLOWED_ATTR, d) : Ge),
        (Se = "ALLOWED_NAMESPACES" in e ? l({}, e.ALLOWED_NAMESPACES, De) : Dt),
        (ge = "ADD_URI_SAFE_ATTR" in e ? l(P(Ke), e.ADD_URI_SAFE_ATTR, d) : Ke),
        (Xe = "ADD_DATA_URI_TAGS" in e ? l(P(qe), e.ADD_DATA_URI_TAGS, d) : qe),
        (z = "FORBID_CONTENTS" in e ? l({}, e.FORBID_CONTENTS, d) : Ve),
        (j = "FORBID_TAGS" in e ? l({}, e.FORBID_TAGS, d) : {}),
        (he = "FORBID_ATTR" in e ? l({}, e.FORBID_ATTR, d) : {}),
        (H = "USE_PROFILES" in e ? e.USE_PROFILES : !1),
        (We = e.ALLOW_ARIA_ATTR !== !1),
        (_e = e.ALLOW_DATA_ATTR !== !1),
        (Be = e.ALLOW_UNKNOWN_PROTOCOLS || !1),
        ($e = e.ALLOW_SELF_CLOSE_IN_ATTR !== !1),
        ...
        H &&
          ((m = l({}, O(ft))),
          (p = []),
          H.html === !0 && (l(m, ut), l(p, ct)),
          H.svg === !0 && (l(m, we), l(p, xe), l(p, ie)),
          H.svgFilters === !0 && (l(m, Ce), l(p, xe), l(p, ie)),
          H.mathMl === !0 && (l(m, Ie), l(p, mt), l(p, ie))),
        e.ADD_TAGS && (m === ze && (m = P(m)), l(m, e.ADD_TAGS, d)),
        e.ADD_ATTR && (p === Ge && (p = P(p)), l(p, e.ADD_ATTR, d)),
        e.ADD_URI_SAFE_ATTR && l(ge, e.ADD_URI_SAFE_ATTR, d),
        e.FORBID_CONTENTS &&
          (z === Ve && (z = P(z)), l(z, e.FORBID_CONTENTS, d)),
        ye && (m["#text"] = !0),
    ...
    It = l({}, ["title", "style", "font", "a", "script"]),
    re = l({}, we);
  l(re, Ce), l(re, Jt);
  var Oe = l({}, Ie);
  l(Oe, Qt);
  var xt = function (e) {
          ...
          : e.namespaceURI === ee
            ...
            : e.namespaceURI === M
              ? (t.namespaceURI === te && !Qe[u]) ||
                (t.namespaceURI === ee && !Je[u])
                ? !1
                : !Oe[a] && (It[a] || !re[a])
              : !!(k === "application/xhtml+xml" && Se[e.namespaceURI])
        : !1;
    },
    w = function (e) {
    ...
    et = function (e) {
      ...
      return (
        ...
        G === M ? bt.call(t, x ? "html" : "body")[0] : x ? t.documentElement : h
      );
    },
    tt = function (e) {
      return yt.call(
    ...
    rt = function (e) {
      ...
      var a = d(e.nodeName);
      if (
        (C("uponSanitizeElement", e, { tagName: a, allowedTags: m }),
        (e.hasChildNodes() &&
      ...
      if (!m[a] || j[a]) {
        if (
          !j[a] &&
          nt(a) &&
          ((f.tagNameCheck instanceof RegExp && _(f.tagNameCheck, a)) ||
            (f.tagNameCheck instanceof Function && f.tagNameCheck(a)))
        )
          return !1;
        if (ye && !z[a]) {
          var u = ue(e) || e.parentNode,
            E = Et(e) || e.childNodes;
          if (E && u)
      ...
      return (e instanceof N && !xt(e)) ||
        ...
        : (F &&
            ...
            (t = R(t, ve, " ")),
            e.textContent !== t &&
              (X(n.removed, { element: e.cloneNode() }), (e.textContent = t))),
          C("afterSanitizeElements", e, null),
          !1);
    },
    at = function (e, t, a) {
      if (je && (t === "id" || t === "name") && (a in s || a in Ct)) return !1;
      if (!(_e && !he[t] && _(Rt, t))) {
        if (!(We && _(Ot, t))) {
          if (!p[t] || he[t]) {
            if (
      ...
      if (h) {
        ...
        for (E = h.length; E--; ) {
          ...
          var ae = t,
            ...
            Ne = ae.namespaceURI;
          if (
            ((a = v === "value" ? t.value : Kt(t.value)),
            (u = d(v)),
            (T.attrName = u),
            (T.attrValue = a),
            (T.keepAttr = !0),
            (T.forceKeepAttr = void 0),
            C("uponSanitizeAttribute", e, T),
            (a = T.attrValue),
            !T.forceKeepAttr && (Le(v, e), !!T.keepAttr))
          ) {
            if (!$e && _(/\/>/i, a)) {
              Le(v, e);
              continue;
            ...
            F &&
              ((a = R(a, pe, " ")), (a = R(a, de, " ")), (a = R(a, ve, " ")));
            var ot = d(e.nodeName);
            if (at(ot, u, a)) {
              if (
                (Ye && (u === "id" || u === "name") && (Le(v, e), (a = Nt + a)),
                S &&
                  I(q) === "object" &&
              ...
              try {
                Ne ? e.setAttributeNS(Ne, v, a) : e.setAttribute(v, a),
                  st(n.removed);
              } catch {}
            }
          }
    ...
    Pt = function i(e) {
      ...
      for (C("beforeSanitizeShadowDOM", e, null); (t = a.nextNode()); )
        C("uponSanitizeShadowNode", t, null),
          !rt(t) && (t.content instanceof c && i(t.content), it(t));
  ...
  return (
    (n.sanitize = function (i) {
      ...
      if (((be = !i), be && (i = "<!-->"), typeof i != "string" && !V(i)))
        ...
        } else throw Me("toString is not a function");
      if (!n.isSupported) {
        if (
          I(r.toStaticHTML) === "object" ||
          typeof r.toStaticHTML == "function"
        ) {
      ...
      if (
        (Ae || Re(e), (n.removed = []), typeof i == "string" && (Y = !1), Y)
      ) {
        if (i.nodeName) {
          var T = d(i.nodeName);
          if (!m[T] || j[T])
        ...
        if (((t = et(i)), !t)) return U ? null : Q ? ce : "";
      }
      t && Ee && w(t.firstChild);
      for (var ae = tt(Y ? i : t); (u = ae.nextNode()); )
        (u.nodeType === 3 && u === E) ||
          rt(u) ||
          (u.content instanceof c && Pt(u.content), it(u), (E = u));
      ...
      return (
        x &&
          ...
          _(sr, t.ownerDocument.doctype.name) &&
          (v =
            "<!DOCTYPE " +
            t.ownerDocument.doctype.name +
            `>
` +
            v),
        F && ((v = R(v, pe, " ")), (v = R(v, de, " ")), (v = R(v, ve, " "))),
        S && Q ? S.createHTML(v) : v
      );
    }),
